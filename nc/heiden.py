...
class Creator(nc.iso.Creator):
    ...
    def rapid(self, x=None, y=None, z=None, a=None, b=None, c=None ):
        ...
        nc.iso.Creator.rapid(self, x, y, z, a, b, c, False)
        self.write(' FMAX\n')
    ...
    def spindle(self, s, clockwise):
        ...
        self.s.set(s)
        nc.iso.Creator.tool_change(self, self.saved_tool_id, False)
        self.write_spindle()
        self.write('\n')
    ...
    def arc_cw(self, x=None, y=None, z=None, i=None, j=None, k=None, r=None):
        if self.output_arcs_as_lines:
            nc.iso.Creator.arc_cw(self, x, y, z, i, j, k, r)
        else:
            self.heidenhain_arc(x, y, i, j, True)

    def arc_ccw(self, x=None, y=None, z=None, i=None, j=None, k=None, r=None):
        if self.output_arcs_as_lines:
            nc.iso.Creator.arc_ccw(self, x, y, z, i, j, k, r)
        else:
