...
SITE_PACKAGES=/home/dan/.local/lib/python3.8/site-packages
cp $SITE_PACKAGES/wx/*.py $TEMP_FOLDER/lib/wx
cp $SITE_PACKAGES/wx/*.so $TEMP_FOLDER/lib/wx
cp $SITE_PACKAGES/wx/*.so.5 $TEMP_FOLDER/lib/wx
...
cp /usr/local/lib/libboost_python38.so.1.76.0 $TEMP_FOLDER/lib
...
zip -r -q /home/dan/Heeks2.zip Heeks2
echo 'finished'
